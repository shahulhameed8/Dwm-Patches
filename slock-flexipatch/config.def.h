...
static const char *user  = "thavalsh";
static const char *group = "thavalsh"; // use "nobody" for arch
...
//static const int logow = 1;   /* grid width and height for right center alignment*/
//static const int logoh = 1;


//static const int logosize = 75;
//static const int logow = -40;   /* grid width and height for right center alignment*/
//static const int logoh = 20;



static const int logosize = 250 ;
static const int logow = -1;   /* grid width and height for right center alignment*/
